...
SELECT res,
  ...
  round(count(*) * h3_cell_area(h3_latlng_to_cell(point(0, 0), res), 'km^2')::numeric) AS approx_area_km2,
  round(100.0 * count(*) * h3_cell_area(h3_latlng_to_cell(point(0, 0), res), 'km^2')
