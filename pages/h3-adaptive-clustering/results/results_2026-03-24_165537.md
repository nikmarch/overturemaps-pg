...
**05_validation**: Spatial overlap validation. Converts cells to polygons and checks that no cell contains another. overlapping_pairs should be 0.

### overlapping_cells (294728.5ms)
