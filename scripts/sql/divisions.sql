...
INSERT INTO pg.public.divisions (id, geography, osm_id, name)
SELECT
    id,
    geometry,
...
CALL postgres_execute('pg', 'CREATE INDEX IF NOT EXISTS divisions_geography_idx ON divisions USING GIST (geography)')
